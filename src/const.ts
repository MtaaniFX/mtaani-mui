...
export const AppDescription = "Your first steps in making an investment that counts";
...
export const AppDomain = 'https://mtaani.devhive.buzz';
export const AppDomainNoProtocol = 'mtaani.devhive.buzz';
